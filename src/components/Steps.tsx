...
import { RiPenNibLine, RiShoppingCartLine, RiGift2Line } from "react-icons/ri";

const steps = [
  {
    title: "Choose & personalise",
    desc: "Pick a product and add a name or logo. We use high-speed laser engraving for a crisp finish.",
    Icon: RiPenNibLine,
  ...
  {
    title: "Enjoy",
    desc: "Receive your personalised gift at your doorstep. Perfect for gifting or self-use.",
    Icon: RiGift2Line,
        ...
        <div className="mt-16 grid gap-6 md:grid-cols-3 md:gap-4 lg:gap-6">
          {steps.map((step, i) => (
            <div key={step.title} className="relative flex flex-col items-center">
              {/* Connector line (desktop): runs through icon center */}
              <div
              ...
              <div
                className={`relative rounded-3xl border border-[var(--border)] bg-white p-8 shadow-sm transition-all duration-300 hover:shadow-xl hover:border-[var(--accent)]/30 ${step.bgGlow} hover:scale-[1.02]`}
              >
                {/* Step number badge */}
                ...
                <div className="flex flex-col items-center text-center">
                  <div
                    className={`flex h-20 w-20 items-center justify-center rounded-2xl bg-gradient-to-br ${step.accent} text-white shadow-lg`}
                  >
